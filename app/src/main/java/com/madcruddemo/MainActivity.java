...
public class MainActivity extends AppCompatActivity implements ServiceRVAdapter.ServiceClickInterface{

    private RecyclerView serviceRV;
    private ProgressBar idProgressBar;
    private FloatingActionButton idAddFab;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idAddFab.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void displayBottomSheet(ServiceRVModel serviceRVModel){
        ...
        Button editBtn = bottomSheetDialog.findViewById(R.id.btnEditService);
        Button viewDetailsBtn = bottomSheetDialog.findViewById(R.id.btnViewDetails);
        ...
        viewDetailsBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.setData(Uri.parse(serviceRVModel.getServiceImage()));
                startActivity(i);
            }
        });
    }
